...
public final class Bech32Test {
	...
	@Test
	public void testSegwitToAndFromBech32() {
		String[][] cases = { { "bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4", "bc", "0", "751E76E8199196D454941C45D1B3A323F1433BD6" },
	...
	@Test
	public void testBitGroupsToAndFromBech32() {
		Object[][] cases = { { "a12uel5l", "a", new byte[0] },
				{ "an83characterlonghumanreadablepartthatcontainsthenumber1andtheexcludedcharactersbio1tt5tgs",
						"an83characterlonghumanreadablepartthatcontainsthenumber1andtheexcludedcharactersbio", new byte[0] },
				...
				{ "split1checkupstagehandshakeupstreamerranterredcaperred2y9e3w", "split", new byte[] { 24, 23, 25, 24, 22, 28, 1, 16, 11, 29, 8, 25, 23, 29,
						19, 13, 16, 23, 29, 22, 25, 28, 1, 16, 11, 3, 25, 29, 27, 25, 3, 3, 29, 19, 11, 25, 3, 3, 25, 13, 24, 29, 1, 25, 3, 3, 25, 13 } },
				{ "?1ezyfcl", "?", new byte[0] }, };
		for (Object[] cs : cases) {
	...
	@Test
	public void testCheckHumanReadablePartValid() {
		String[] cases = { "a", "bc", "1", "111", "the-quick.brown*fox", };
		for (String cs : cases)
			Bech32.checkHumanReadablePart(cs.toCharArray());
	}

	@Test
	public void testCheckHumanReadablePartInvalid() {
		String[] cases = { "", "012345678901234567890123456789012345678901234567890123456789012345678901234567890123",
				"abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz", "A", "xXx", "\u0020", "\u007F",
				"\u0080", "\u2000", "\uD852\uDF62", };
		for (String cs : cases) {
			try {
				Bech32.checkHumanReadablePart(cs.toCharArray());
